...
def check_llms(findings: list[Finding]) -> None:
    ...
    required_links = [
        ...
        f"{PRODUCTION_URL}/docs/guangzhou",
        f"{PRODUCTION_URL}/docs/hangzhou",
        f"{PRODUCTION_URL}/docs/shenzhen",
        f"{PRODUCTION_URL}/docs/nanjing",
        f"{PRODUCTION_URL}/docs/chengdu",
        ...
        f"{PRODUCTION_URL}/docs/nanjing/jiangbei-yanchuangyuan-renting-guide",
        f"{PRODUCTION_URL}/docs/chengdu/tencent-renting-guide",
        f"{PRODUCTION_URL}/docs/chengdu/huawei-renting-guide",
        f"{PRODUCTION_URL}/docs/chengdu/bytedance-renting-guide",
        f"{PRODUCTION_URL}/docs/hangzhou/netease-renting-guide",
        f"{PRODUCTION_URL}/docs/hangzhou/kuaishou-renting-guide",
        f"{PRODUCTION_URL}/docs/chengdu/alibaba-renting-guide",
        f"{PRODUCTION_URL}/docs/chengdu/baidu-renting-guide",
        f"{PRODUCTION_URL}/docs/chengdu/netease-renting-guide",
        f"{PRODUCTION_URL}/docs/chengdu/kuaishou-renting-guide",
        f"{PRODUCTION_URL}/docs/nanjing/xuzhuang-xianlin-renting-guide",
        f"{PRODUCTION_URL}/docs/nanjing/hexi-south-station-renting-guide",
        f"{PRODUCTION_URL}/docs/nanjing/tuniu-renting-guide",
        f"{PRODUCTION_URL}/docs/nanjing/focuschina-renting-guide",
