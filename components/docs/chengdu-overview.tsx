...
const officeAnchors = [
	...
	{
		name: "阿里巴巴成都",
		role: "成都高新区新经济头部企业项目样本",
		area: "成都高新区 / 高新南区方向，具体楼栋以团队通知为准",
		track: "电商平台、云服务、本地生活、数字化业务",
		commuteLogic: "先确认团队是否固定在高新南区、新川或客户现场，再决定近场、外扩或短租过渡。",
		guideHref: "/docs/chengdu/alibaba-renting-guide",
		source: "https://talent.alibaba.com/off-campus/position-list",
	},
	{
		name: "百度成都",
		role: "成都高新区 AI / 云 / 平台项目样本",
		area: "成都高新区 / 高新南区方向，团队楼栋和驻场形态需要确认",
		track: "AI、智能云、搜索、商业化、政企项目",
		commuteLogic: "优先问清固定办公还是客户现场；不确定时用火车南站或桐梓林做短期兜底。",
		guideHref: "/docs/chengdu/baidu-renting-guide",
		source: "https://talent.baidu.com/jobs/list",
	},
	{
		name: "快手成都",
		role: "成都高新区内容平台与商业化项目样本",
		area: "成都高新区 / 高新南区方向，具体办公楼栋和班次以团队通知为准",
		track: "短视频内容平台、商业化、运营审核、产品研发",
		commuteLogic: "内容和运营类岗位要把晚归路线、打车点和小区门禁放到租金前面一起算。",
		guideHref: "/docs/chengdu/kuaishou-renting-guide",
...
const mapMarkers = [
	...
	{ label: "阿里成都", detail: "高新区项目", x: 64, y: 63 },
	{ label: "百度成都", detail: "AI / 云项目", x: 68, y: 62 },
